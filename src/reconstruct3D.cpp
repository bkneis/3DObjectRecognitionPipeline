...
//    Mat downRight;
//
//    pyrDown(left, downLeft);
//    pyrDown(right, downRight);
//
//    auto stereo = StereoSGBM::create(16, 96, 5, 5184, 82944, 1, 0, 10, 100, 32);
//
//    Mat disp;
//    stereo->compute(downLeft, downRight, disp);
//
//    int height = downLeft.rows;
//    int width = downLeft.cols;
//
//    double focalLength = width / 0.8;
//
//    Mat Q(4, 4, CV_64F);
//
//    Q.at<double>(0, 0) = 1.0;
//    Q.at<double>(0, 1) = 0.0;
//    Q.at<double>(0, 2) = 0.0;
//    Q.at<double>(0, 3) = -0.5 * width;
//
//    Q.at<double>(1, 0) = 0.0;
//    Q.at<double>(1, 1) = -1.0;
//    Q.at<double>(1, 2) = 0.0;
//    Q.at<double>(1, 3) = -0.5 * height;
//
//    Q.at<double>(2, 0) = 0.0;
//    Q.at<double>(2, 1) = 0.0;
//    Q.at<double>(2, 2) = 0.0;
//    Q.at<double>(2, 3) = 0 - focalLength;
//
//    Q.at<double>(3, 0) = 0.0;
//    Q.at<double>(3, 1) = 0.0;
//    Q.at<double>(3, 2) = 1.0;
